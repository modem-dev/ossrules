...
export function ProjectTitle({ project, section }: { project: AgentsProject; section: 'Agent Rules' | 'Agent Skills' }) {
    return (
        <div className="min-w-0">
            <div className="project-title-row">
                ...
                <h1 className="page-title project-page-title">
                    <span className="project-title-name">{project.name}</span> <span className="project-title-section">{section}</span>
                </h1>
            </div>
