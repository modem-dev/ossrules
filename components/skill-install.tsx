...
export function SkillInstall({ command }: { command: string }) {
    ...
    return (
        ...
        >
            ...
            <div className="modem-surface absolute left-0 top-full z-30 mt-2 w-[min(48rem,calc(100vw-3rem))] overflow-hidden rounded border border-gray-750 shadow-lg sm:left-auto sm:right-0">
                <div className="flex items-center gap-3 px-4 py-3 font-mono text-xs leading-6">
                    ...
                    <section
                        ...
                        className="min-w-0 flex-1 overflow-x-auto whitespace-pre text-light-cream [color-scheme:dark] [scrollbar-width:thin]"
                    >
                        <code>{command}</code>
                    </section>
