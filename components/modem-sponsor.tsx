    ...
    return (
        <section aria-label="Sponsored by Modem" className="modem-sponsor modem-surface mt-16">
            <div className="mb-6 flex flex-wrap items-center gap-3">
                ...
                <a href="https://modem.dev/2026" target="_blank" rel="noopener noreferrer">
            ...
            <div className="flex flex-wrap items-end justify-between gap-6">
                ...
                <a href="https://modem.dev/2026" target="_blank" rel="noopener noreferrer" className="action-link action-primary shrink-0">
